...
$lang = array_merge($lang, array(
	...
	'LOGIN_ERROR_LOGINNAME'				=> 'You have specified an incorrect login name. Please check your login name and try again. If you continue to have problems please contact the %sBoard Administrator%s.',
	// End Sep Login Name Mod	
	...
	'REMOVE'					=> 'Remove',
	'REMOVE_INSTALL'			=> 'Diskmaster is busy having a long painful chat with the server and database. Please stand by. We control the vertical. We control the horizontal. I am the shadow that you never expect to see behind you when returning home from work. My name is Darkwing Duck!',
	'REPLIES'					=> 'Replies',
